package com.opentrace.issuers.driver;
...
public class MongoClientDriver {
    ...
    public MongoTemplate getMongoTemplate(){
        if(mongoTemplate ==null) {
            // System.out.println(mongodb_host + "," + mongodb_port + "," + database + "," + collection);
            ...
            //MongoClient mongoClient = new TracingMongoClient(jaegerTracer, "localhost", 27017);
